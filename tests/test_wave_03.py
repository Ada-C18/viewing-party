...
def test_friends_unique_movies_not_duplicated():
    ...
    # Assert
    assert len(friends_unique_movies) == 3
    assert friends_unique_movies[0] not in amandas_data["watched"]
    assert friends_unique_movies[1] not in amandas_data["watched"]
    assert friends_unique_movies[2] not in amandas_data["watched"]
