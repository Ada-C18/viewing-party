...
def test_friends_unique_movies_not_duplicated():
    ...
    # assert {"title": "The Programmer: An Unexpected Stack Trace"} in friends_unique_movies
    # # assert {"title": "It Came from the Stack Trace"} in friends_unique_movies
    # # assert {"title": "Zero Dark Python"} in friends_unique_movies
    # *************************************************************************************************
