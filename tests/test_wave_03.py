...
def test_friends_unique_movies_not_duplicated():
    ...
    # Assert
    assert len(friends_unique_movies) == 3
    assert friends_unique_movies[0]["title"] == "The Programmer: An Unexpected Stack Trace" and friends_unique_movies[1]["title"] == "It Came from the Stack Trace" and friends_unique_movies[2]["title"] == "Zero Dark Python"
