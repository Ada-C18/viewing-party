...
def test_friends_unique_movies_not_duplicated():
    ...
    assert friends_unique_movies == [{'title': 'The Programmer: An Unexpected Stack Trace', 'genre': 'Fantasy', 'rating': 4.0}, {'title': 'It Came from the Stack Trace', 'genre': 'Horror', 'rating': 3.5}, {'title': 'Zero Dark Python', 'genre': 'Intrigue', 'rating': 3.0}]
    # **************************************************************************************************
