...
def test_friends_unique_movies_not_duplicated():
    ...
    assert INTRIGUE_3 in friends_unique_movies #AL
    assert FANTASY_1 not in friends_unique_movies #AL 
    assert friends_unique_movies == [FANTASY_4, HORROR_1, INTRIGUE_3] #AL 
