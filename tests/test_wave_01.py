...
# @pytest.mark.skip() # <- comment this line out when ready to run tests
def test_create_successful_movie():
    ...
    # Act
    new_movie = create_movie(movie_title, genre, rating) #adding a breakpoint here is suggested becuase this is a place where the function is called (not just defined like in part.py line 3)
