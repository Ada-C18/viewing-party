...
def test_adds_movie_to_user_watched():
    # Arrange
    movie = {"title": MOVIE_TITLE_1, "genre": GENRE_1, "rating": RATING_1}
    user_data = {"watched": []}
...
def test_moves_movie_from_watchlist_to_empty_watched():
    # Arrange
    janes_data = {
        "watchlist": [{"title": MOVIE_TITLE_1, "genre": GENRE_1, "rating": RATING_1}],
        "watched": [],
    }
...
def test_moves_movie_from_watchlist_to_watched():
    ...
    janes_data = {"watchlist": [FANTASY_1, movie_to_watch], "watched": [FANTASY_2]}
...
def test_does_nothing_if_movie_not_in_watchlist():
    # Arrange
    movie_to_watch = HORROR_1
    janes_data = {"watchlist": [FANTASY_1], "watched": [FANTASY_2]}
