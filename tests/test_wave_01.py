...
def test_moves_movie_from_watchlist_to_empty_watched():
    ...
    assert updated_data["watched"][0]["title"] == MOVIE_TITLE_1
    assert updated_data["watched"][0]["genre"] == GENRE_1
   # assert updated_data["watched"][0][0]["rating"] == RATING_1
...
def test_does_nothing_if_movie_not_in_watchlist():
    ...
    # Assert
    assert len(updated_data["watchlist"]) == 1 # this should be 1 - indicates movie was not movied into watchlist
    assert len(updated_data["watched"]) == 1 # this should be 1
