...
def test_moves_movie_from_watchlist_to_empty_watched():
    ...
    # COMPLETED --  Add assertions here to test that the correct movie was added to "watched" **********
...
def test_moves_movie_from_watchlist_to_watched():
    ...
    assert updated_data['watched'][0]['title'] == FANTASY_2['title']
    #raise Exception (Add assertions here to test that the correct movie was added to "watched") 
