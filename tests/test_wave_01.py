...
def test_moves_movie_from_watchlist_to_empty_watched():
    ...
    # check assert 
    # added assert test below
    assert janes_data["watchlist"] not in janes_data["watched"]
...
def test_moves_movie_from_watchlist_to_watched():
    ...
    # added assert test below
    assert movie_to_watch in janes_data["watched"]
    assert movie_to_watch not in janes_data["watchlist"]
