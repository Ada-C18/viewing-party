...
def test_moves_movie_from_watchlist_to_empty_watched():
    ...
    assert len(updated_data["watched"]) == 1
    # We want to assert that the title of the movie we watched is equal to the title of the movie in the list of watched movies, since theres only one movie in the watched movies we know that the movie will be at the 0th index
...
def test_moves_movie_from_watchlist_to_watched():
    ...
    # We want to assert that the movie we watched is in the list of watched movies
